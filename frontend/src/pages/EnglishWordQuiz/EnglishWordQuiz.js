...
const EnglishWordQuiz = () => {
  ...
  const fetchQuizData = async (level) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_API_URL}/english-exercise/word-quiz/`, {
        method: 'POST',
        headers: {
...
export default EnglishWordQuiz;
