...
import './EnglishIdiomQuiz.css';

const EnglishIdiomQuiz = () => {
  ...
  const fetchQuizData = async (level) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_API_URL}/english-exercise/idiom-quiz/`, {
        method: 'POST',
        headers: {
...
export default EnglishIdiomQuiz;
